...
* **Comparison 1 (T_KO vs T_WT):** Stood as a clean baseline with 0 significant DEGs under the strict threshold ($padj < 0.05, |log2FC| \ge 1$), showing that removing the suppressor within already established tumor environments does not induce further global transcriptional shifts.
* **Comparison 2 (N_KO vs N_WT):** Only two significant DEGs were identified (*Slc7a5* and *2340079G19Rik*), suggesting that KCASH2 loss alone has a limited transcriptional impact in normal tissue and does not produce broad transcriptomic alterations.
* **Comparison 3 (T_KO vs N_KO):** A total of 2,452 significant DEGs were identified. Among the most significant genes were *Tgm3*, *Adh1*, *Atp12a*, *Bmp3*, and *Hes6*, reflecting extensive transcriptional changes associated with the tumor-versus-normal transition in the KO background.
* **Comparison 4 (T_WT vs N_WT):** A total of 3,223 significant DEGs were identified. Notable changes included reduced expression of *Aqp8* and *Zg16* and increased expression of *Cxcl5* and *Stra6*, consistent with tumor-associated transcriptional alterations in the WT background.
