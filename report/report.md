...
* **Comparison 1 (T_KO vs T_WT):** No significant DEGs (0 genes) were detected under the applied thresholds (`padj < 0.05`, `|log2FC| ≥ 1`), indicating that KCASH2 loss in an established tumor background does not induce additional global transcriptional changes.
